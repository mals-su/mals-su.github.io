...
Slideout.prototype.close = function() {
  ...
  setTimeout(function() {
    ...
    self.panel.style.transition = self.panel.style['-webkit-transition'] = self.panel.style[prefix + 'left'] = self.panel.style.transform = '';
    self.emit('close');
  }, this._duration + 50);
  return this;
};
...
Slideout.prototype._translateXTo = function(translateX) {
  ...
  this.panel.style[prefix + 'transform'] = this.panel.style.left = translateX + 'px';
  return this;
};
...
Slideout.prototype._setTransition = function() {
  //this.panel.style[prefix + 'transition'] = this.panel.style.transition = prefix + 'transition ' + this._duration + 'ms ' + this._fx;
  return this;
};
...
Slideout.prototype._initTouchEvents = function() {
  ...
  this._onTouchMoveFn = function(eve) {
    ...
    if (Math.abs(dif_x) > 20) {
      ...
      self.panel.style[prefix + 'transform'] = self.panel.style.left = translateX + 'px';
